...
function EntriesList(){
    ...
    return (
        ...
        <div className="min-h-screen" style={{backgroundImage: `url('img/bg.png')`}}>
            <div className="border-4 border-yellow-100 rounded-md shadow-2xl mx-72 bg-white">
                ...
                <div className="rounded-lg pb-60">
                    <table className="w-1/2 ml-auto mr-auto mt-3">
                        <thead>
                            <tr className="rounded" style={{backgroundImage: `url('img/bg.png')`}}>
                                <th className="headers rounded-2xl text-2xl px-4 py-2">All Entries</th>
                            </tr>
                        </thead>
                        <tbody className = "body text-xl">
                            {entries.filter((entry) => {
                                ...
                                return (
                                    <tr key={id}>
                                        <td className="border px-4 py-2 mt-5 flex items-center">
                                            <div className="w-28">
